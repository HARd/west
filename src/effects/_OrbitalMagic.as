package effects{
	...
	public class OrbitalMagic extends Sprite {
		...
		public function OrbitalMagic() {
			...
			tween.to(orb, {degree:360}, 1, Linear.easeNone, 0, null, onComplete).repeatType = TweensyTimeline.REPLAY;
