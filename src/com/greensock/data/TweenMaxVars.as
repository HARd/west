...
//---- PLUGIN REQUIRED -------------------------------------------------------------------------------------------
		 ...
		 * simply call reverse() on the timeline to watch the particles re//trace their steps right back to the beginning. 
		 ...
		 * re//trace their steps right back to the beginning. Here are the parameters you can define (note that 
